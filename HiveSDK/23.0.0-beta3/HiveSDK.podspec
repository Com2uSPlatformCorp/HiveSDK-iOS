Pod::Spec.new do |spec|
  ...
  spec.resource_bundles = {'HIVECore' => ["#{$vendored_frameworks_path}/HIVECore.xcframework/**/*.{xcprivacy}"],
                           'HIVEService' => ["#{$vendored_frameworks_path}/HIVEService.xcframework/**/*.{xcprivacy}"]} 
