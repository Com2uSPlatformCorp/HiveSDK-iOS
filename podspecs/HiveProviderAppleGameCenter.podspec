Pod::Spec.new do |spec|
  spec.name         = "HiveProviderAppleGameCenter"
  spec.version      = "4.23.0.0-beta1"
  spec.summary      = "HiveAppleGameCenter optional framework"
  spec.description  = "HiveAppleGameCenter to use Apple Game Center sign-in with Hive SDK."
