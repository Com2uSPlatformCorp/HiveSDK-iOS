...
PRE_HIVE_SDK_VERSION="24.3.0-beta4"
...
UPDATE_ADJUSTV3_VERSION="4.38.4"
...
UPDATE_HIVE_SDK_VERSION="24.3.0-beta5"
...
sed -i '' "s/$PRE_ADJUSTV3_VERSION/$UPDATE_ADJUSTV3_VERSION/" HiveAnalyticsProviderAdjustSignatureV3.podspec
