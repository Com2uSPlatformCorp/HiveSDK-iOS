# PRE에 명시된 버전명을 UPDATE로 일괄 교체
# 터미널에서 ./VersionManager 실행 시 podspec에 반영됨

# 이미 podspec에 작성되어있는 버전
PRE_HIVE_SDK_VERSION="4.16.3.2-beta1"
PRE_HERCULES_VERSION="20221031"
PRE_ADJUST_VERSION="4.33.3"
PRE_APPSFLYER_VERSION="6.9.1"
PRE_FACEBOOK_12_VERSION="12.3.0"
PRE_FACEBOOK_13_VERSION="13.2.0"
...
# 신규로 podspec에 작성할 버전
UPDATE_HIVE_SDK_VERSION="4.16.3.2"
...
UPDATE_FACEBOOK_12_VERSION=$PRE_FACEBOOK_12_VERSION
UPDATE_FACEBOOK_13_VERSION=$PRE_FACEBOOK_13_VERSION
...
sed -i '' "s/$PRE_FACEBOOK_12_VERSION/$UPDATE_FACEBOOK_12_VERSION/" HiveProviderFacebook.podspec
sed -i '' "s/$PRE_FACEBOOK_13_VERSION/$UPDATE_FACEBOOK_13_VERSION/" HiveProviderFacebook.podspec
