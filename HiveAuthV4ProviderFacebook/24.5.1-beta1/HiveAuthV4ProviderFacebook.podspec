Pod::Spec.new do |spec|
  ...
  spec.dependency 'FBSDKCoreKit', '17.1.0'
  spec.dependency 'FBSDKLoginKit', '17.1.0'
  spec.dependency 'FBSDKShareKit', '17.1.0'
  spec.dependency 'FBSDKGamingServicesKit', '17.1.0'
